...
const SEED_DATA: { title: string; data: Record<string, unknown> }[] = [
  ...
  { title: 'Winter Wheat - WestBred WB4303', data: { name: 'Winter Wheat - WestBred WB4303', type: 'Crop', status: 'ready', description: '120 acres of hard red winter wheat', variety: 'WestBred WB4303', fieldName: 'East Section', plantDate: '2024-09-25', expectedHarvest: '2025-06-20', seedSource: 'WestBred', rowSpacing: '7.5"', estimatedYield: 65, yieldUnit: 'bu/ac', pestPressure: 'Moderate', notes: 'Applied fungicide at flag leaf' } },
  { title: 'Angus Herd - Main', data: { name: 'Angus Herd - Main', type: 'Animal', status: 'growing', description: 'Primary commercial Angus cow-calf operation', species: 'Cattle', breed: 'Black Angus', headCount: 85, pasture: 'South Pasture', lastVetVisit: '2025-03-01', nextVetVisit: '2025-06-01', feedType: 'Grass + mineral supplement', weightAvg: 1150, notes: 'Spring calving started, 12 calves so far' } },
  { title: 'John Deere 8R 310', data: { name: 'John Deere 8R 310', type: 'FarmEquipment', status: 'ready', description: 'Primary row-crop tractor', equipmentType: 'Tractor', make: 'John Deere', model: '8R 310', year: 2022, hours: 2450, lastService: '2025-02-01', nextService: '2025-05-01', condition: 'Excellent', notes: 'GPS/autosteer equipped' } },
  { title: 'North Pivot Irrigation', data: { name: 'North Pivot Irrigation', type: 'WaterSystem', status: 'growing', description: 'Center-pivot irrigation on North Quarter', systemType: 'Center Pivot', coverageAcres: 155, flowRate: 850, flowUnit: 'gpm', waterSource: 'Well #3', scheduleFreq: 'Every 3 days during peak', lastInspection: '2025-03-15', notes: 'New nozzles installed spring 2025' } },
  { title: 'Fall Corn Harvest 2024', data: { name: 'Fall Corn Harvest 2024', type: 'Harvest', status: 'sold', description: 'North Quarter corn harvest', crop: 'Corn', field: 'North Quarter', harvestDate: '2024-10-18', quantity: 32000, quantityUnit: 'bu', quality: 'Grade A', storageLocation: 'Bin 2', pricePerUnit: 4.85, buyer: 'Cargill Elevator', notes: 'Moisture at 14.2%, test weight 57.8 lb/bu' } },
  { title: 'USDA Organic - Fields 1-3', data: { name: 'USDA Organic - Fields 1-3', type: 'Certification', status: 'growing', description: 'Organic certification for transition fields', certBody: 'Oregon Tilth', certType: 'USDA Organic', issueDate: '2024-01-15', expiryDate: '2027-01-15', certNumber: 'OT-2024-88291', inspectionDue: '2025-09-01', notes: 'Year 2 of 3-year transition' } },
];
