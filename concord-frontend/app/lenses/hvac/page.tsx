...
import {
  Thermometer, Wrench, ClipboardList, DollarSign, Camera, Users,
  Plus, Search, X, Trash2, BarChart3, CheckCircle2,
  AlertTriangle, FileText, Shield, Award, Calculator,
  Layers, ChevronDown, Receipt, Fan, Gauge,
} from 'lucide-react';
  ...
  return (
    <div data-lens-theme="hvac" className="space-y-6 p-6">
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2"><DTUExportButton domain="hvac" data={{}} compact /><button onClick={() => setShowDashboard(!showDashboard)} className={cn(showDashboard ? ds.btnPrimary : ds.btnSecondary)}><BarChart3 className="w-4 h-4" /> Dashboard</button></div>
      </header>
