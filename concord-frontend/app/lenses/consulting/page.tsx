...
export default function ConsultingLensPage() {
  ...
  return (
    <LensShell lensId="consulting" asMain={false}>
      <FirstRunTour lensId="consulting" />      <DepthBadge lensId="consulting" size="sm" className="ml-2" />
    <LensPageShell
      domain="consulting"
      title="Consulting"
    ...
    >
      ...
      <a href="#consulting-skip" className="sr-only focus:not-sr-only focus:ring-2 focus:ring-amber-500 focus:outline-none">Skip to consulting content</a>          <CrossLensRecentsPanel lensId="consulting" sinceDays={7} limit={6} hideWhenEmpty className="mt-3" />
    </LensShell>
  );
}
