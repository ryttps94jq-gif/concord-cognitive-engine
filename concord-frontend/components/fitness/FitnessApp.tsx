...
type ModeTab = 'Clients' | 'Programs' | 'Workouts' | 'Classes' | 'Teams' | 'Recruiting' | 'Log' | 'HRZones' | 'Recovery' | 'Activity' | 'AIPlan' | 'Finish' | 'Routes' | 'Feed';
...
const MODE_TABS: { id: ModeTab; icon: React.ComponentType<{ className?: string; size?: number | string }>; defaultType: ArtifactType }[] = [
  ...
  { id: 'Finish', icon: Award, defaultType: 'Workout' },
  { id: 'Routes', icon: MapPin, defaultType: 'Workout' },
  { id: 'Feed', icon: Activity, defaultType: 'Workout' },
];
...
export default function FitnessApp() {
  ...
  return (
    ...
    <div className={ds.pageContainer}>
      ...
      {activeTab === 'Finish' && <div className="p-4"><WorkoutFinishPanel /></div>}
      {activeTab === 'Routes' && <RoutesPanel className="mt-2" />}
      {activeTab === 'Feed' && <div className="p-4"><FitnessFeed /></div>}
