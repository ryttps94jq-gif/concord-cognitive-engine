  ...
  return [
    {
      id: '1',
      title: 'First Thought',
      description: 'Create your first DTU',
      icon: Brain,
    ...
    },
    {
      ...
      description: 'Create 10 connections between DTUs',
      icon: GitBranch,
    ...
    },
    {
      id: '3',
      title: 'Deep Thinker',
      description: 'Create a MEGA DTU through synthesis',
      icon: Sparkles,
    ...
    },
    {
      id: '5',
      title: 'Enlightened',
      description: 'Create a HYPER DTU',
      icon: Crown,
      iconColor: 'text-yellow-400',
