...
export const LENS_REGISTRY: LensEntry[] = [
  ...
  { id: 'root', name: 'Refusal Algebra', icon: Hash, description: 'Base-6 Refusal Algebra numeral system — convert, compute, and explore semantic number theory', category: 'science', showInSidebar: false, showInCommandPalette: true, path: '/lenses/root', order: 134, keywords: ['base-6', 'refusal algebra', 'glyphs', 'numeral', 'semantic', 'pivot', 'bridge'] },
