...
describe('BLE advertisement cycle time', () => {
  it('starts/stops advertiser 100 times in under 500ms', async () => {
...
describe('transfer throughput', () => {
  ...
  it('chunks and reassembles 1KB payload 100 times in under 500ms', () => {
...
describe('relay hop latency', () => {
  it('enqueues 1000 DTUs to relay engine in under 500ms', () => {
  ...
  it('processes relay queue of 100 entries in under 500ms', async () => {
  ...
  it('deduplication check 10000 hashes in under 100ms', () => {
    const relay = createRelayEngine();
