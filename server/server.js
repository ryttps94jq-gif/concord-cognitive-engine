...
// LLM toggle: default ON only when a key is present; override via LLM_DEFAULT=0/1
const __envBool = (v) => String(v || "").toLowerCase().trim();
const __llmDefaultEnv = __envBool(process.env.LLM_DEFAULT);
const __llmDefaultForced = (__llmDefaultEnv === "1" || __llmDefaultEnv === "true") ? true : (__llmDefaultEnv === "0" || __llmDefaultEnv === "false") ? false : null;
...
const DEFAULT_LLM_ON = (__llmDefaultForced !== null)
  ? __llmDefaultForced
